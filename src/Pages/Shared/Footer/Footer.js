  ...
  return (
    <div className="bg-slate-900 text-white" sx={{ py: 3 }}>
      <div className="md:mx-40 py-10 text-center md:text-left">
        <div className="md:grid  md:grid-cols-4 flex flex-col md:flex-row justify-between">
          <div>
          ...
          <div className="mb-5 md:mb-0">
            <h4 className="text-3xl mb-1"> BOOKS AND COURSES</h4>
            <ul>
              <li>
          ...
          <div className="mb-5 md:mb-0">
            <h4 className="text-3xl mb-1"> TRAVEL TIPS</h4>
            <ul>
              <li>
                <a href="#">Start Here</a>
              </li>
